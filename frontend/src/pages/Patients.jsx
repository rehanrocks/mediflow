/* src/pages/Patients.jsx - Searchable patient records with route-based actions. */
...
export function Patients() {
  ...
  const canEditPatients = !user || ['admin', 'receptionist'].includes(user.role)
  const canDeletePatients = !user || user.role === 'admin'
