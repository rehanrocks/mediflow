...
from appointments.permissions import IsStaffMember
...
class DoctorViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        ...
        if self.action in ('checkin', 'checkout'):
            return [IsAuthenticated(), IsStaffMember(), HasFeature('doctors')()]
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if request.user.role == 'doctor' and request.user.pk != instance.pk:
