...
from .models import User, DoctorAttendance, Qualification


@admin.register(User)
class UserAdmin(BaseUserAdmin):
    fieldsets = BaseUserAdmin.fieldsets + (
        ('Organization', {'fields': ('organization', 'role', 'role_obj')}),
        ('Doctor Profile', {'fields': (
            'phone', 'qualification', 'qualification_obj', 'specializations',
